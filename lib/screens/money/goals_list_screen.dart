      ...
      child: goals.when(
        ...
        data: (list) => list.isEmpty
            ? const Center(
                child: EmptyState(
                  title: 'No goals yet',
                  body: 'Create a goal to start building your future.',
                ),
              )
            : ListView.separated(
                ...
                itemBuilder: (_, i) {
                  ...
                  return FvCard(
                    onTap: () =>
                        pushScreen(context, GoalDetailScreen(goalId: g.id)),
                    child: Row(
                      children: [
            ...
            children: [
              ...
              if (!goal.completed)
                FvButton(
                  ...
                  onPressed: () =>
                      _contribute(context, ref, goal, accounts.value),
                ),
              ...
              if (goal.contributions.isEmpty)
                const EmptyState(
                  ...
                  body: 'Your contributions will appear here.',
                )
              else
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 2),
                              Text(
                                FvFormat.formatDate(c.date, language: language),
                                style: TextStyle(
                                  fontSize: 12.5,
                                  color: context.fvTextSecondary,
                                ),
