...
router.post('/security/two-factor/enable', authenticate, asyncWrap(settingsController.enableTwoFactorWithCodes));
router.post('/security/two-factor/verify-recovery', authenticate, asyncWrap(settingsController.verifyRecoveryCode));
router.get('/security/two-factor/recovery-status', authenticate, asyncWrap(settingsController.getRecoveryCodesStatus));
