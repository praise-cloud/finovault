      ...
      <ScrollView className="flex-1 px-margin-mobile" contentContainerStyle={{ paddingBottom: 120 }}>
        <View className="mt-6 mb-6">
          <View className="flex-row justify-between items-end gap-4">
            ...
            <Pressable className="bg-primary px-6 py-3 rounded-full active:scale-95 transition-all" style={{ shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, elevation: 4 }}>
        ...
        <View className="gap-gutter">
          ...
          <View className="flex-row flex-wrap" style={{ gap: 24 }}>
            <View className="bg-surface-container-lowest rounded-xl p-md border border-outline-variant/30" style={[{ shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, shadowRadius: 20, elevation: 2 }, isMd ? { flex: 7 } : { width: '100%' }]}>
              ...
              <Pressable className="w-full mt-md py-2 items-center"><Text className="text-on-surface-variant font-label-md text-label-md underline">View All Round-ups</Text></Pressable>
            </View>
